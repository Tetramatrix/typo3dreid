...
Sprite[0] = new Image(); Sprite[0].src="typo3conf/ext/ch_dreid/static/gfx/ballrot.gif";
Sprite[1] = new Image(); Sprite[1].src="typo3conf/ext/ch_dreid/static/gfx/ballblau.gif";
Sprite[2] = new Image(); Sprite[2].src="typo3conf/ext/ch_dreid/static/gfx/ballgruen.gif";
Sprite[3] = new Image(); Sprite[3].src="typo3conf/ext/ch_dreid/static/gfx/ballgelb.gif";
Sprite[4] = new Image(); Sprite[4].src="typo3conf/ext/ch_dreid/static/gfx/ballora.gif";
Sprite[5] = new Image(); Sprite[5].src="typo3conf/ext/ch_dreid/static/gfx/balltuerk.gif";
Sprite[6] = new Image(); Sprite[6].src="typo3conf/ext/ch_dreid/static/gfx/ballmag.gif";
Sprite[7] = new Image(); Sprite[7].src="typo3conf/ext/ch_dreid/static/gfx/ballcya.gif";
Sprite[8] = new Image(); Sprite[8].src="typo3conf/ext/ch_dreid/static/gfx/ballgruen.gif";
...
/**************************************************/
// Figur Würfel by Michaël (_SoLO_) THOMAS  
// 21/07/99
// MikeJ51@hotmail.com
/**************************************************/
...
/**************************************************/
// Transform technique by Michaël (_SoLO_) THOMAS  
// 21/07/99
// MikeJ51@hotmail.com
/**************************************************/
...
/***********************************************************************************************************/
// 3d rout by Michaël (_SoLO_) THOMAS
// 21/07/99
// MikeJ51@hotmail.com
//
// Adapted by Chi Hoang 19.03.03
// Ursprünglich dreht dies rout (x,y,z). ich habe die perspektivische Abbildung und die Anzeige hinzugefügt.
...
switch(hilf_timer){
case 20: hilf_cpu.innerHTML='<span id="fussnote">VBL: '+(old_vbl).toFixed(2)+' (Peak)<br>VBL: '+(vbl).toFixed(2)+' (Current)<br>Less is better!</span>';hilf_timer=0;break;
}
}  
